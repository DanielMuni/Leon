...
public class UnirPuntos_Nivel2 extends AppCompatActivity {
    ...
    private static UnirPuntos_Nivel2 instance; //Se declara la instancia de la clase
    ...
    //Se declaran las funciones UnirPuntos_Nivel2 y getInstance para llamar a la clase en otros archivos
