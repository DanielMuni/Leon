...
public class UnirPuntos_Nivel1 extends AppCompatActivity {
    ...
    private static UnirPuntos_Nivel1 instance; //Se declara la instancia de la clase
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unir_puntos_nivel1);
        ...
        btn1 = findViewById(R.id.upNivel1_btn);
        btn2 = findViewById(R.id.upNivel1_btn2);
        btn3 = findViewById(R.id.upNivel1_btn3);
        btn4 = findViewById(R.id.upNivel1_btn4);
    ...
    * MenuPrincipal*/
    ...
    //Se declaran las funciones UnirPuntos_Nivel1 y getInstance para llamar a la clase en otros archivos
    public UnirPuntos_Nivel1() {
        instance = this;
    }

    public static UnirPuntos_Nivel1 getInstance() {
        return instance;
    }
